        ...
        <>
            <div className='space-y-7' data-testid="wallet-page">
                ...
                <div className='grid gap-5 lg:grid-cols-2'>
                    <div className='nw-card flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between' data-testid="wallet-balance-card">
                        <div className="min-w-0">
                            <p className='nw-mono flex items-center gap-2'><LuWallet className="h-3.5 w-3.5" /> {t.admin?.walletBalance || "Wallet balance"}</p>
                            <p className="mt-2 font-display text-4xl font-bold tracking-tight text-primary dark:text-white" data-testid="wallet-balance">
                    ...
                    <div className='nw-card flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between' id="rewards" data-testid="wallet-rewards-card">
                        <div className="min-w-0">
                            <p className='nw-mono flex items-center gap-2'><LuGift className="h-3.5 w-3.5" /> {t.admin?.rewardPoints || "Reward points"}</p>
                            <p className="mt-2 font-display text-4xl font-bold tracking-tight text-brand-700 dark:text-brand-300" data-testid="wallet-points">
                                {points.toFixed(2)}
                            </p>
