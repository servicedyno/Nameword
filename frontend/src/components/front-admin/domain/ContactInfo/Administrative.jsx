...
import EditAdministrative from "./EditAdministrative";
import { useLanguage } from "../../../../hooks/useLanguage";

const Administrative = ({ data, onRefresh, onEdit }) => {  
...
${t.admin.company} ${data?.company_name || 'N/A'}`;
    ...
    const handlePaste = async () => {
        ...
        try {
            ...
            console.log("[Administrative Paste] Using update API for HostBay");
            console.log("[Administrative Paste] Contact data to update:", contactData);
            console.log("[Administrative Paste] Domain:", currentDomain.websiteName);
            console.log("[Administrative Paste] Existing handle:", data?.handle || 'admin');
    ...
    return (
        <div>
            {/* <p className="info-card-title px-5 py-4">Administrative Contact</p>
